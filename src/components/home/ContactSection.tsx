    ...
    <section className="section-frame bg-white py-[4.5rem] lg:py-24" aria-label="Contact and location">
      <div className="container-main">
        <div className="grid grid-cols-1 items-start gap-10 md:grid-cols-2 md:gap-16 lg:gap-20">
          <div>
            <div
              className="image-shell aspect-[16/9] w-full bg-gradient-to-br from-highlight via-white to-accent-bg"
              aria-hidden="true"
            />
          </div>
          ...
          <div className="max-w-xl">
            ...
            <div className="panel-card mt-8 space-y-5 p-6">
              <div>
        ...
        <div className="panel-card mt-14 bg-[linear-gradient(180deg,rgba(232,244,240,0.78),rgba(255,255,255,0.9))] p-6 text-center md:p-10">
          <p className="font-serif text-[1.55rem] leading-[1.1] tracking-[-0.03em] text-text-main">
